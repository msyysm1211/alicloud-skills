...
| network/esa | alicloud-network-esa | Manage Alibaba Cloud Edge Security Acceleration (ESA) via OpenAPI/SDK. Use for site lifecycle management, DNS/record operations, origin and cache rules, WAF/security policy management, and diagnostics/troubleshooting for ESA resources. | `skills/network/esa/alicloud-network-esa` |
