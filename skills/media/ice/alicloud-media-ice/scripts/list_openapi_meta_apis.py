#!/usr/bin/env python3
"""Fetch OpenAPI metadata API list for Alibaba Cloud ICE and save to output/."""
...
DEFAULT_PRODUCT_CODE = "ice"
DEFAULT_VERSION = "2020-11-09"
OUTPUT_DIR = pathlib.Path("output/alicloud-media-ice")
