#!/usr/bin/env python3
"""Fetch OpenAPI metadata API list for Alibaba Cloud Live and save to output/."""
...
DEFAULT_PRODUCT_CODE = "live"
DEFAULT_VERSION = "2016-11-01"
OUTPUT_DIR = pathlib.Path("output/alicloud-media-live")
