#!/usr/bin/env python3
"""Fetch OpenAPI metadata API list for Alibaba Cloud VOD and save to output/."""
...
DEFAULT_PRODUCT_CODE = "vod"
DEFAULT_VERSION = "2017-03-21"
OUTPUT_DIR = pathlib.Path("output/alicloud-media-vod")
